...
| # | Item | Plan |
|---|------|------|
| 1 | [Multi-Content-Type Support](plans/01-multi-content-type.md) | Ensure every API route supports JSON + HTML + CSV |
...
| 13 | [JS Modernization](plans/13-js-modernization.md) | ES Modules + JSDoc types, extract inline scripts, XSS fixes |
