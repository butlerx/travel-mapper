(function () {
  ...
  var n2a = {
    ...
    '512':'OM','516':'NA','520':'NR','524':'NP','528':'NL','530':'AN','533':'AW','540':'NC',
    ...
    '634':'QA','638':'RE','642':'RO','643':'RU','646':'RW','654':'SH','659':'KN','660':'AI',
    '662':'LC','666':'PM','670':'VC','674':'SM','678':'ST','682':'SA','686':'SN','688':'RS',
    '690':'SC','694':'SL','702':'SG','703':'SK','704':'VN','705':'SI','706':'SO','710':'ZA',
    '716':'ZW','720':'YE','724':'ES','732':'EH','736':'SD','740':'SR','744':'SJ','748':'SZ',
  ...
  info.update = function (name, count) {
    if (name) {
      this._div.innerHTML = '<strong>' + name + '</strong><br>' + (count || 0) + ' visit' + (count === 1 ? '' : 's');
  ...
  legend.onAdd = function () {
    ...
    for (var i = 0; i < grades.length; i++) {
      div.innerHTML +=
        ...
        '<span class="stats-map-legend-swatch" style="background:' + getColor(grades[i]) + '"></span>' +
        labels[i] + '</div>';
    }
    return div;
  };
